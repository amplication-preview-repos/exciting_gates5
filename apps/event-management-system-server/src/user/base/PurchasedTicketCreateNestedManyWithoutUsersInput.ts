...
@InputType()
class PurchasedTicketCreateNestedManyWithoutUsersInput {
...
export { PurchasedTicketCreateNestedManyWithoutUsersInput as PurchasedTicketCreateNestedManyWithoutUsersInput };
