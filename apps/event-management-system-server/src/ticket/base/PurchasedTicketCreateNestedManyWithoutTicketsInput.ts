...
@InputType()
class PurchasedTicketCreateNestedManyWithoutTicketsInput {
...
export { PurchasedTicketCreateNestedManyWithoutTicketsInput as PurchasedTicketCreateNestedManyWithoutTicketsInput };
