...
@InputType()
class PurchasedTicketCreateNestedManyWithoutTicketTiersInput {
...
export { PurchasedTicketCreateNestedManyWithoutTicketTiersInput as PurchasedTicketCreateNestedManyWithoutTicketTiersInput };
