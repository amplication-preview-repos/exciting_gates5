...
@InputType()
class PurchasedTicketCreateNestedManyWithoutEventsInput {
...
export { PurchasedTicketCreateNestedManyWithoutEventsInput as PurchasedTicketCreateNestedManyWithoutEventsInput };
